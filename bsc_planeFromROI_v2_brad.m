function [roiOUT] = bsc_planeFromROI_v2_brad(roiIN,location,atlas)
...
switch lower(location)
    case 'top'
        ...
        roiOUT=bsc_makePlanarROI_v3_brad(atlas,roiCoord, 'z');
    case 'superior'
        roiCoord=max(roiIN.coords(:,3));
        roiOUT=bsc_makePlanarROI_v3_brad(atlas,roiCoord, 'z');
    case 'bottom'
    ...
    case 'anterior'
        ...
        roiOUT=bsc_makePlanarROI_v3_brad(atlas,roiCoord, 'y');
    case 'posterior'
    ...
    case 'medial'
        if LRflag
            ...
            roiOUT=bsc_makePlanarROI_v3_brad(atlas,roiCoord, 'x');
        else
